...
# angular.module('videoAppControllers').controller(
#   'MainCtrl', ($scope, $modal) ->
#     console.log "MainCtrl constructor"
# )

# videoApp = angular.module('videoApp', ['videoAppControllers'])

# videoAppControllers = angular.module('videoAppControllers', [])

# videoAppControllers.controller(
#   'MainCtrl', ($scope) ->
#     console.log "MainCtrl constructor"
# )
